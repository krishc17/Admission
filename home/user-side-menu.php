...
<div class="col-md-3">
   <div class="list-group">
      ...
      <a href="apply.php" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Apply<span class="badge"></span></a>      <a href="logout.php" class="list-group-item"><span     aria-hidden="true"></span> Logout <span class="badge"></span></a>
   </div>
</div>